...
bool LightShaderClass::Render(ID3D11DeviceContext* deviceContext, int indexCount, int instanceCount, 
	...
	XMFLOAT3 lightDirection, XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor[], XMFLOAT4 lightPosition,
	XMFLOAT3 cameraPosition, XMFLOAT4 specularColor, float specularPower)
{
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, texture, 
		lightDirection, ambientColor, diffuseColor, lightPosition, cameraPosition, specularColor, specularPower);
	if(!result)
	{
		return false;
	}
...
bool LightShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, 
	XMMATRIX worldMatrix, XMMATRIX viewMatrix, XMMATRIX projectionMatrix, 
	ID3D11ShaderResourceView* texture, 
	XMFLOAT3 lightDirection, XMFLOAT4 ambientColor, XMFLOAT4 diffuseColor[], XMFLOAT4 lightPosition, XMFLOAT3 cameraPosition, XMFLOAT4 specularColor, float specularPower)
{
	HRESULT result;
